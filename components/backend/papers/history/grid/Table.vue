...
<template>
  ...
  import BackendPapersHistoryGridActions from "~/components/backend/papers/history/grid/Actions.vue";
  import BackendPapersHistoryGridColumn from "~/components/backend/papers/history/grid/Column.vue";
  ...
  const datatableAjax = {
    ...
    data: (d: any) => {
      ...
      return {
        ...d,
        URL: "/PaperBackEnd/grid/order/list",
        Token: token,
  ...
  const datatableOptions = {
    ...
    createdRow: async function (row: any, data: any) {
      ...
      const menu = await renderToString(
        h(BackendPapersHistoryGridActions, { 
            row: data 
        })
      );
      ...
      const order = await renderToString(
        h(BackendPapersHistoryGridColumn, {
          row: data,
          field: "order",
        })
      );
