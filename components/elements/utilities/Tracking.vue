    ...
    <div class="card-body">
      ...
      <section class="timeline is-vertical">
        ...
        <!-- <template v-if="orderTrack" v-for="(item, i) in orderTrack.slice($props.indexSequence, orderTrack.length)"
          :key="i"> -->
        <template v-if="orderTrack" v-for="(item, i) in  orderTrack.slice(0, orderTrack.length)" :key="i">
            ...
            <template v-if="i !== 0 || (i === 0 && $props.isShowchild)">
              ...
              <template v-for="(child, j) in item.Child.slice().reverse()" :key="j">
                ...
                <div class="timeline-list">
                  ...
                  <div
                    :class="['timeline-item', 'is-child', (j === 0 && i === props.indexCurrent) ? 'is-current' : '', useUtility().getClassStatusOrder(child?.StatusCode)]">
          ...
          <div class="timeline-list">
            ...
            <!-- <div :class="['timeline-item', 'is-success']" v-if="item.Parent?.Type !== 'OrderComplete' || (item.Parent?.Type === 'OrderComplete' && $props.isShowchild !== true)"> -->
            <div :class="['timeline-item', useUtility().getClassStatusParent(i, props.indexCurrent)]">
              <div class="datetime">
              ...
              <figure class="timeline-icon">
                <div :class="['icon', (i >= props.indexCurrent) ? 'check' : '']"></div>
              </figure>
              <div class="detail">
