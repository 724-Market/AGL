  ...
  <section class="site-sidebar is-sticky">
    <aside class="card">
      ...
      <div class="card-body card-table">
        <PapersExchangeSummary :exchange-data="$props.exchangeData" :match-all-list="$props.matchAllList"
          :payment-fee-limit="$props.paymentFeeLimit" :shipping-fee="$props.shippingFee"
          :shipping-method="$props.shippingMethod"></PapersExchangeSummary>
      </div>
      <!-- Component Checklist -->
      <OrderChecklist :list="props.checkList" @change-check-save="handlerCheckSave" />
    </aside>
    <button loading="false" class="formkit-input btn-continue btn btn-primary btn-accept pledge-action" type="button"
      name="order-submit" id="order-submit" :disabled="!checkSave" @click="onContinue">
      ไปต่อ
    </button>
