    ...
    <div class="card-body">
      ...
      <div class="form-placeorder">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <FormKit type="number" label="กำหนดวงเงินต่อวัน (บาท)" name="CreditLimit"
          ...
          <div class="col-md-6">
            <FormKit type="number" label="ผลตอบแทน (%)" name="Commission" :value="props.userDetails?.Commission" min="0"
